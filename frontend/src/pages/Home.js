...
function Home() {
    ...
    const styles = `
        ...
        * {
        ...
        .stats-container {
            ...
            /*
             * Stats are now clearly below the hero.
             * Negative margin is intentionally smaller.
             */
            margin: 18px auto 0;
        ...
        /* Four different subtle backgrounds */
    ...
    const renderCarCard = (variant) => {

        const available =
            getAvailableCars(variant) > 0;
                ...
                <div className="car-body">
                    ...
                    <div className="car-title-row">
                        ...
                        <div>
                            ...
                            <p className="car-company">
                                {getCompanyName(variant)}
                            </p>
            ...
            <section className="ev-section">
                ...
                <div className="ev-wrapper">
                    ...
                    >
                        ...
                        <div className="ev-benefit-content">

                            <span className="ev-benefit-label">
                                WHY CHOOSE EV
                            </span>
            ...
            <footer className="footer">
                ...
                <div className="footer-main">
                    ...
                    <div className="footer-column">
                        ...
                        <a
                            href="mailto:g4golden1401@gmail.com"
                        >
                            📧 g4golden1401@gmail.com
                        </a>

                        <a
                            href="tel:+918002118249"
                        >
                            📞 +91 8002118249
                        </a>
